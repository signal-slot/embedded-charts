...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let layouts = vec![
        ...
        LayoutDemo {
            ...
            charts: vec![
                (GridPosition::new(0, 0), "Full Screen", Rgb565::RED),
            ],
        },
        ...
        LayoutDemo {
            ...
            charts: vec![
                (GridPosition::with_span(0, 0, 2, 2), "Main\n(2x2)", Rgb565::RED),
        ...
        LayoutDemo {
            ...
            charts: vec![
                (GridPosition::with_span(0, 0, 2, 3), "Main Chart", Rgb565::RED),
                ...
                (GridPosition::new(2, 3), "Status 4", Rgb565::new(255, 128, 0)),
            ],
        },
    ];
    ...
    loop {
        ...
        // Draw title
        Text::with_alignment(
            &format!("Layout {}/{}: {}", current_layout + 1, layouts.len(), layout.name),
            Point::new(400, 30),
            title_style,
            Alignment::Center,
        )
