...
use embedded_charts::{
    dashboard::{SimpleDashboard, GridPosition, LayoutPreset, DashboardLayout},
};
...
fn test_get_all_viewports() {
    ...
    let viewports: heapless::Vec<Rectangle, 4> = dashboard.get_all_viewports(total_viewport, 3).unwrap();
