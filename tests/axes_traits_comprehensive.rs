...
fn test_tick_equality_and_clone() {
    ...
    assert_eq!(cloned.is_major, true);
...
fn test_axis_renderer_trait_usage() {
    ...
    // Test draw_axis_line
    renderer
        .draw_axis_line(Point::new(0, 0), Point::new(100, 0), &line_style, &mut display)
        .unwrap();
    ...
    // Test draw_grid_line
    renderer
        .draw_grid_line(Point::new(0, 0), Point::new(0, 100), &line_style, &mut display)
        .unwrap();
